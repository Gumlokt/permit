export default {
  ...
  state: {
    editing: false,
    newPermitActionPath: { // store path by default
      path: 'api/permits',
      method: 'POST'
    },
    storedPermits: [],
    newPermit: { id: null, number: null, surname: null, forename: null, patronymic: null, company: null, position: null, dateStart: null, dateEnd: null, },
  },

  mutations: {
    fillInNewPermit(state, payload) { // temporary method for development cases
      state.newPermit = { id: null, number: null, surname: 'Иванов', forename: 'Иван', patronymic: 'Иванович', company: 'ООО Рога и Копыта', position: 'Ведущий специалист', dateStart: '20.08.2021', dateEnd: '15.08.2021', };
    ...
    resetNewPermit(state, payload) {
      ...
      state.newPermit = { id: null, number: null, surname: null, forename: null, patronymic: null, company: null, position: null, dateStart: null, dateEnd: null, };
    },
